...
<html lang="en">
	...
	<body>
		<div id="wrapper">
			...
			<?php
			include_once ("includes/header-3.php");
			?>
			...
			<div id="main">
					...
					<div class="rev_slider banner-slider">
						<ul>
							...
							<li data-transition="random" data-slotamount="7" data-masterspeed="500">
								<!-- MAIN IMAGE -->
								<img src="assets/img/slide-banner-05.jpg" alt="banner" data-bgfit="cover" data-bgposition="center 36%" data-bgrepeat="no-repeat">
								...
								class="tp-caption sft banner-heading">
									<h2> When we give cheerfully &amp; accept gratefully, everyone is blessed</h2>
								</div>
								...
								class="tp-caption sft read-more-btn">
									<a data-toggle="modal" href="external.php" data-target=".donate-form" class="btn btn-default">read more</a>
								</div>
							</li>
							<!-- SLIDE  -->
							<li data-transition="random" data-slotamount="7" data-masterspeed="500" >
								<!-- MAIN IMAGE -->
								<img src="assets/img/slide-banner-02.jpg" alt="banner" data-bgfit="cover" data-bgposition="center 36%" data-bgrepeat="no-repeat">
							...
							<div class="col-xs-12">
								...
								<div class="col-xs-12 col-md-4 item-wrapper">
									<div class="items zoom">
										...
										<div class="item-content">
											<h3>Help african children to have homes</h3>
											<span class="donation">Donation : <span class="value">$78,354 / $1,26,500</span></span>
											...
											<p>Lorem ipsum dolor sit consectetur adipiscing elit ellentesque. Future stuffs also goes...</p>
								...
								<div class="col-xs-12 col-md-4 item-wrapper">
									<div class="items zoom">
										...
										<div class="item-content">
											<h3>African girls need your help for educations</h3>
											<span class="donation">Donation : <span class="value">$78,354 / $1,26,500</span></span>
											<div class="progress-bar-section">
												<div class="progress">
													<div class="progress-bar" role="progressbar" aria-valuenow="35" aria-valuemin="0" aria-valuemax="100" style="width:35%;"></div>
								...
								<div class="col-xs-12 col-md-4 item-wrapper">
									<div class="items zoom">
										...
										<div class="item-content">
											<h3>Help african children need food lreom ipsum</h3>
											<span class="donation">Donation : <span class="value">$78,354 / $1,26,500</span></span>
											<div class="progress-bar-section">
												<div class="progress">
													<div class="progress-bar" role="progressbar" aria-valuenow="35" aria-valuemin="0" aria-valuemax="100" style="width:35%;"></div>
				...
				<section class="help-people">
					<div class="container">
						<div class="row">
							<div class="col-md-8">
								<h2>We can change <span>life with the help to people africa </span></h2>
								<p class="message">Fusce suscipit varius mium sociis natoque penatibus magnis dis parturient montes nascetur ridiculus mususce feugiat malesua orbi nunc odio gravida. cursus nec luctus a loremaecenas tristique orci ac semuis ultricies pharetra magna.</p>
								<div class="row">
									<div class="col-md-6">
										<h3>Heading title </h3>
										<p>Duis id sodales metus, eu efficitur massa tiam consequat tellus at sem pulvinar efficitur.Nunc id tortor rutrum orci blandit efficitur. </p>
									</div>
									<div class="col-md-6">
										<h3>Heading title </h3>
										<p>Duis id sodales metus, eu efficitur massa tiam consequat tellus at sem pulvinar efficitur.Nunc id tortor rutrum orci blandit efficitur. </p>
								...
								<div class="video-section">
									<img  src="assets/img/video-pic2.jpg" data-video="http://www.youtube.com/embed/wN3gueLT0D8?autoplay=1" alt=""> 
									<div class="control">
										<h2>Watch our media video</h2>
										<a href="#" class="play-btn"> <i class="fa fa-play-circle-o"></i> </a>
									</div>
								</div>
							</div>
							<div class="col-md-4">
								<h2>How you can help ? <span>See Below </span></h2>
								<div class="help-block">
									<h3><a href="our-story.php"><img src="assets/svg/megaphone.svg" alt="Media Help" />Media Helping</a></h3>
									<p>Duis id sodales metus, eu efficitur massa tiam consequat tellus at sem pulvinar efficitur.Nunc id tortor rutrum orci blandit efficitur. </p>
								</div>
								<div class="help-block">
									<h3><a href="volunteer.php"><img src="assets/svg/user.svg"  alt="Become Volunteer" />Become Volunteer </a></h3>
									<p>Duis id sodales metus, eu efficitur massa tiam consequat tellus at sem pulvinar efficitur.Nunc id tortor rutrum orci blandit efficitur. </p>
								</div>
								<div class="help-block">
									<h3><a href="external.php" data-toggle="modal" data-target=".donate-form">
										<img src="assets/svg/heart.svg" alt="Send Donation" />Send Donation</a></h3>
									<p>Duis id sodales metus, eu efficitur massa tiam consequat tellus at sem pulvinar efficitur.Nunc id tortor rutrum orci blandit efficitur. </p>
								</div>
							</div>
						</div>
							...
							<div class="col-xs-12 col-md-7">
								<div class="row">
									<header class="page-header section-header col-md-12 clearfix">
										<h2>Latest News <strong>Charity</strong></h2>
									</header>
									<div class="items zoom col-xs-12 col-md-12">
										...
										<div class="media col-md-7">
											<h3>Blog News Heading Title</h3>
											
											<span class="date"><i class="fa fa-calendar font-icon"></i> 03 DEC 2013</span><span class="posted-in"><i class="fa fa-tag font-icon"></i> Posted In : category</span>
											<p>
												Lorem ipsum dolor sit consectetur adipiscing elit llentesque small project decriptions Lorem ipsum dolor sit consectetur
											</p>
									...
									<div class="items zoom col-xs-12 col-md-12">
										...
										<a href="#" class="img-thumb col-md-5">
										<figure>
											<img src="assets/img/slide-banner-01.jpg" alt="">
										</figure> </a>
										<div class="media col-md-7">
											<h3>Blog News Heading Title</h3>
											<span class="date"><i class="fa fa-calendar font-icon"></i> 03 DEC 2013</span><span class="posted-in"><i class="fa fa-tag font-icon"></i> Posted In : category</span>
								...
								<div class="volunteer-reward">
									...
									<header class="page-header">
										<span class="svg-shape user-svg-shape">
												<img src="assets/svg/user.svg" class="svg" alt="Get Involved">
											</span>
									...
									<p>Integer accumsan nec orci at lacinia. Duis id sodales metus, eu efficitur massa am consequat tellus at sem  tortor rutrum orci blandit efficitur.</p>
				...
				<section class="donation-holder holders">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<h2>What Donation Holders say </h2>
									  ...
									  <ul class="slides">
									    <li>
									    	...
									    	<div class="img-circle photo-frame">
									    		<img src="assets/img/img-testimonial.jpg" alt="" class="img-circle">
									    	</div>
									      	<blockquote>
												<p> <i class="fa fa-quote-left quote-mark"></i>
			...
			<?php
			include_once ("includes/footer-3.php");
			?>
