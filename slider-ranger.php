			...
			<div id="main">
				...
				<section class="content-wrapper container" id="page-info">
					...
					<div class="col-xs-12 col-md-3">
						...
						<li class="active"><a href="ranger.php"><i class="fa fa-angle-double-right bullet-arrow"></i>Slider Ranger</a></li>
					...
					<!--Slider Ranger Section Start Here-->
					<div class="col-xs-12 col-md-9">
						<h2 class="h4 page-header">Slider Ranger Heading Title</h2>
						...
						<div class="bs-example">
							...
							<span class="progress-value-number">65%</span>
										</div>
							<div class="progress">
							...
							<div class="progress">
											<div class="progress-bar slide-ranger" role="progressbar" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100" style="width:65%">
					...
					<!--Slider Ranger Section End Here-->
					</div>
