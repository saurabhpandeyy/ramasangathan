<footer id="footer" class="footer-third">
					...
					<div class="row">
						<div class="col-xs-12 col-sm-5">
							<div class="footer-logo">
								<a href="index.html" title="Welcome to Charity">About Charity</a>
							</div>
							<p>
								There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour.There are many variations of pm, by injected humour.
							</p>
						...
						<div class="col-xs-12 col-sm-4">
							<h6>Stay current with our Email Newsletter.</h6>
				...
				<div class="copyright copyright-alternate">
					<div class="container">
						<div class="row">
							<div class="col-xs-12"><span> &copy; Copyright 2014, All Rights Reserved by Charity Theme.</span>
							</div>
						</div>
					</div>
				</div>
