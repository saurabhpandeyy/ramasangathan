							...
							<div class="col-xs-12">
								...
								<div class="portfolio-detail-description">
									...
									<div class="row portfolio-details">
										<div class="col-xs-12">
											...
											<div class="detail-description">
												...
												<strong class="detail-summary">
													Phllus felis purus placerat vel augue vitae aliquam tincidunt dolor sed hendrerit diam in mat tis mollis donecut Phasellus felis purus placerat vel augue vitae, aliquam tincidunt dolor. Sed hendrerit diam in mattis mollis.
												</strong>
												<p>
													Phllus felis purus placerat vel augue vitae aliquam tincidunt dolor sed hendrerit diam in mat tis mollis donecut Phasellus felis purus placerat vel augue vitae, aliquam tincidunt dolor. Sed hendrerit diam in mattis mollis. Donec ut tincidunt magna. Nullam hendrerit pellentesque pellentesque. Sed ultrices arcu non dictum porttitor. Phllus felis purus placerat vel augue vitae aliquam tincidunt dolor sed hendrerit diam in mat tis mollis donecut Phasellus felis purus placerat vel augue vitae, aliquam tincidunt dolor.

												</p>

												<p>

													Phllus felis purus placerat vel augue vitae aliquam tincidunt dolor sed hendrerit diam in mat tis mollis donecut Phasellus felis purus placerat vel augue vitae, aliquam tincidunt dolor.
												</p>

												<ul class="list-unstyled yello-icon">

													<li>
														Become genuinely interested in the other person Nam ac leo arcu At eget congu
													</li>
													<li>
														Smile (very important).
													</li>
													<li>
														Remember that a person’s name is to that person tost important sound in
														any language.
													</li>
													<li>
														Be a good listener Encourage others to talk about themselves congue jptos himenaeos
													</li>
													<li>
														Speak in terms of the other person’s interests  Nam ac leo arat Suspendisse eget
													</li>
													<li>
														Make the other person feel important and do it sincerely
													</li>
													<li>
														that a person’s name is to that person the sweetest andound in any language.
													</li>
										...
										<header class="page-header section-header text-left">
												<h2 class="text-left h3">Related Portfolio</h2>
											</header>
