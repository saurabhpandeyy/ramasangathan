			...
			<!--Breadcrumb Section Start Here-->
				...
				<section class="content-wrapper container" id="page-info">
					...
					<div class="col-xs-12 col-md-3">
						<nav class="side-nav">
								<ul>
						<li class="active"><a href="typography.php"><i class="fa fa-angle-double-right bullet-arrow"></i>Typography</a></li>
					...
					<!--Typography Section Start Here-->
					<div class="col-xs-12 col-md-9">
						<h2 class="h4 page-header">Typography  Heading Title</h2>
						...
						<div class="heading-group">
							<h1>&lt;h1&gt;Typography Heading Title&lt;/h1&gt;</h1>
							<h2>&lt;h2&gt;Typography Heading Title&lt;/h2&gt;</h2>
							<h3>&lt;h3&gt;Typography Heading Title&lt;/h3&gt;</h3>
							<h4>&lt;h4&gt;Typography Heading Title&lt;/h4&gt;</h4>
							<h5>&lt;h5&gt;Typography Heading Title&lt;/h5&gt;</h5>
							<h6>&lt;h6&gt;Typography Heading Title&lt;/h6&gt;</h6>
						</div>
						<!--Heading Group Start-->
					</div>
					<!--Typography Section End Here-->
					</div>
					</section>
